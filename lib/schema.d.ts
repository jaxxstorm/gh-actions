...
export declare type Machine = 'linux' | 'macos' | 'windows';
export declare type Architecture = 'ARM32' | 'x64' | 'x86';
export declare type Configuration = string | number | boolean | {
...
export interface GithubWorkflow {
    ...
    jobs: {
        ...
        [k: string]: {
             ...
             */
            'runs-on': ('${{ matrix.os }}' | 'macos-latest' | 'macos-10.15' | 'self-hosted' | 'ubuntu-16.04' | 'ubuntu-18.04' | 'ubuntu-latest' | 'windows-latest' | 'windows-2019') | ([] | [
                {
                    [k: string]: unknown;
                }
            ] | [] | [
